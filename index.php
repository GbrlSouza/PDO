              ...
              if (count($pessoa) > 0) {
                for ($i = 0; $i < count($pessoa); $i++) {
                  ...
                  <td class="text-center">
                    <a href="index.php?id=<?php echo $pessoa[$i]['id']; ?>" class="btn btn-sm btn-warning me-2">
                    ...
                    <a href="index.php?id=<?php echo $pessoa[$i]['id']; ?>" class="btn btn-sm btn-danger">
...
if (isset($_GET['id'])) {
  ...
  echo "<div class='alert alert-success text-center' role='alert'>Pessoa excluída com sucesso!</div>";
} 
?>
